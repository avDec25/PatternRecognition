...
%red line divides red and green
 f1  = ezplot(b12, [0,a(1,1),0,2500]);
 set(f1 , 'color'  , 'r'  );
 hold on;
 f1  = ezplot(b12, [0,800,b(2,1),2800]);
 set(f1 , 'color'  , 'r'  );
 hold on;
 
%black line divides blue and green
  f3 = ezplot(b23, [a(1,1),a(2,1),1400,2500]);
   set(f3 , 'color'  , 'k'  );
    hold on ;
%blue line divides red and blue
 f2 = ezplot(b13, [0,a(2,1),0,b(1,1)]) ;
  set(f2 , 'color'  , 'b'  );
  hold on;
  f2 = ezplot(b13, [a(2,1),1400,0,2500]) ;
  set(f2 , 'color'  , 'b'  );
  hold on;
%  fill(b12,b23,'y');
